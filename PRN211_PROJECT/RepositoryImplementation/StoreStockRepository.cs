...
namespace PRN211_PROJECT.RepositoryImplementation
{
    public class StoreStockRepository : IStoreStockRepository
    {
        ...
        public void CheckoutProductFromStock(int productId, int quantity, int storeId) => StoreStockService.Instance.CheckoutProductFromStock(productId, quantity, storeId);
